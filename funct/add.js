...
const addCourse = async () => {
    ...
    const matkul = (await theQuestion('Masukan tugas mata kuliah: ')).toLowerCase()
    const jumlahSoal = (await theQuestion('Masukan jumlah tugas: ')).toLowerCase()
    const deadline = (await theQuestion('Masukan tanggal pengerjaan [contoh: 12 mei - 19 mei]: ')).toLowerCase()
    console.log('===================================');
